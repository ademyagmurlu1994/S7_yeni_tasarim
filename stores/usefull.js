...
export const usefull = createSlice({
  name: "usefull",
  initialState: {
    cities: [
      ...
      { value: "02", label: "ADIYAMAN" },
      { value: "03", label: "AFYONKARAHİSAR" },
      { value: "04", label: "AĞRI" },
      { value: "05", label: "AMASYA" },
      { value: "07", label: "ANTALYA" },
      { value: "08", label: "ARTVİN" },
      { value: "09", label: "AYDIN" },
...
//export const { isValidTcKimlik } = usefull.actions;
