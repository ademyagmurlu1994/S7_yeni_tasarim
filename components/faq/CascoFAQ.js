...
const CascoFAQ = ({ topic }) => {
  const [state, setState] = useState({
    faqs: [
      ...
      {
        q: "Araç el değiştirdiğinde kasko poliçesi de el değiştirir mi?",
        a: "Hayır değiştirmez, kasko poliçesi iptal edilerek işlememiş günlerin primi gün esasına göre sigortalıya iade edilir. Aracı satın alan kişi kendi kasko poliçesini yaptırmalıdır.",
      },
      {
        q: "Daha önceden oluşmuş hasarları kasko poliçesi yaptırdıktan sonra oluşan hasarlar ile birlikte beyan ederek tazminat talep edebilir miyim?",
        a: "Poliçe başlangıç tarihinden önce oluşmuş hasarların tazminini poliçe döneminde oluşan hasarlar ile birlikte talep etmek söz konusu değildir.",
      },
      {
        q: "Hasarsızlık indirimleri şirket değişikliklerinde de devam eder mi?",
        a: "Hasarsızlık indirimleri sigortalı adına tanımlandığından şirket değişikliği yapıldığında da devam eder hatta söz konusu indirimin eşler arasında geçişi de söz konusudur. ",
      },
    ],
  });
