      ...
      <section className="section">
        <div style={{ marginTop: "100px", marginBottom: "150px" }}>
            ...
            <div className="row">
              <div className=" col-xs-12 col-sm-12 col-md-6 col-lg-6">
                <InsuranceIndexPageInformation
                  title="Trafik Fiyatlarını Sorgulayın, Bütçenize Uygun Seçeneği Kolayca Bulun!"
                  photo={CascoInsuranceInformationPhoto}
                  detailParagraphs={[
                    "En iyi sigorta şirketlerinin tekliflerini karşılaştırın",
                    "İnternete özel ek indirimlerle online trafik sigortanızı satın alın",
              ...
              <div className="row">
                <div className="col-12">
                  <WhatIsTheXInsurance
                    ...
                    title="TRAFİK SİGORTASI NEDİR? NE İŞE YARAR?"
          ...
          <div className="container mt-5">
            <TrafficFAQ topic="TRAFİK SİGORTASI" />
          </div>
        </div>
      </section>
    </>
