  ...
  const saveInquiryInformations = () => {
    ...
    for (var i = 0; i < userList.length; i++) {
      if (i == 0) {
        ...
        ownInfo.birthDate = changeDateFormat(userList[i].birthDate, "yyyy-MM-dd");
        ownInfo.relation = 0;
        ownInfo.profession = userList[i].profession?.value?.toString() || "";
      } else {
        let singleMember = {
          identityNo: userList[i].identityNo.toString(),
          birthDate: changeDateFormat(userList[i].birthDate, "yyyy-MM-dd"),
  ...
  const OneStep = () => {
    return (
      <Box
        ...
        className="animate__animated animate__fadeInRight stepContainer tssStepContainer"
      >
              ...
              <form autoComplete="off" onSubmit={handleSubmit(validateStep)}>
                {userList.map((user, index) => (
                  <div className="user-list-for-health-insurance-wrapper" key={index}>
                    <div className="row">
                      <div className="col-12 col-md-6 col-lg-3 mt-3 mb-2 tc-kimlik-no">
                        <Controller
                          control={control}
                      ...
                      <div className="col-12 col-md-6 col-lg-3 mt-3 mb-2  select-yakinlik-derecesi">
                        <Controller
                          control={control}
                      ...
                      <div className="col-12 col-md-6 col-lg-3 mt-3 select-yakinlik-derecesi">
                        <Controller
                      ...
                      <div className="col-12 col-md-6 col-lg-3 mt-3 select-meslek">
                        <Controller
  ...
  const TwoStep = () => {
    return (
      <Box
        ...
        className="stepContainer tssStepContainer animate__animated  animate__fadeInRight"
      >
        {/*İletişim bilgileri*/}
        <div
          className={
          ...
          <div className="col-12">
            <WhatIsTheXInsurance
              ...
              descriptionParagraphs={[
                "Tamamlayıcı Sağlık Sigortası (Destekleyici Sağlık Sigortası), sağlık güvencesi olan bireylerin Sosyal Güvenlik Kurumu (SGK) ile anlaşmalı özel sağlık kuruluşlarında sadece katılım payı ödeyerek tedavi olmalarını sağlayan özel sağlık sigortasıdır.",
                "Tamamlayıcı sağlık sigortası poliçe limitleri dâhilinde ; yatarak tedavi (ameliyat, günübirlik tedaviler), suni uzuv, tıbbi malzeme, evde bakım ve ambulans masraflarını karşılar. Sınırlı olmak (poliçe üzerinde belirtilir) koşuluyla ayakta tedavi ve belirli şartlar ile bekleme süresi bulunması kaydıyla doğum teminatları da poliçeye eklenebilir.",
                ,
              ]}
            />
          </div>
